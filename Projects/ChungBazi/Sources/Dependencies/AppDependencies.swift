...
enum AppDependencies {
    ...
    /// Amplitude는 내부적으로 스레드 안전하므로 nonisolated(unsafe)로 공유한다.
    nonisolated(unsafe) static let amplitude = Amplitude(configuration: Configuration(apiKey: Config.amplitudeAPIKey))
